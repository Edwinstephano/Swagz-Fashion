...
SECRET_KEY = os.getenv("JWT_SECRET_KEY", "swagz_super_secret_pos_key_2026_menswear")
ALGORITHM = "HS256"
...
def get_password_hash(password: str) -> str:
    # Use HMAC-SHA256 with SECRET_KEY as salt for fast, reliable, zero-bug hashing
