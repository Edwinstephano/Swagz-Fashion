...
# Kill any previous processes on ports 8005, 9101, 3005
echo "🧹 Clearing previous background processes..."
fuser -k 8005/tcp 9101/tcp 3005/tcp 2>/dev/null || true
sleep 1

# 1. Start Local Print Agent (Port 9101)
echo "🖨️  Starting Local Thermal Print Agent on port 9101..."
...
echo " 🖨️  Print Agent: http://127.0.0.1:9101"
echo "========================================================="
